...
M3.14 owns deterministic domain contracts, stable record identity across generated read paths, offline mappings, generated-contract collision validation, field-based Flutter form screens, identified Flutter list/detail screens, shared record display formatting, and a record-aware form bridge for deterministic edit prefill and identity-preserving submit intent. Navigation/route materialization, relation placement in screens, save/delete execution, dashboard/settings/custom screens, create-ID policy, repository composition and provider backend rendering remain later slices.
