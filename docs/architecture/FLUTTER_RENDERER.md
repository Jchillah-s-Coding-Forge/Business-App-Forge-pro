...
M3.12 owns deterministic domain contracts, stable record identity across generated read paths, offline mappings, generated-contract collision validation, field-based Flutter form screens, and identified Flutter list screens. Navigation/route materialization, relation placement in screens, detail/dashboard/settings/custom screens, create-ID policy, repository composition/submit wiring, and provider backend rendering remain later slices.
