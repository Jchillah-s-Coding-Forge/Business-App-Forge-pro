...
M3.9 owns deterministic domain contracts, offline mappings, generated-contract collision validation, and field-based Flutter form screens. Navigation/route materialization, relation placement in screens, list/detail/dashboard/settings/custom screens, repository submit wiring, and provider backend rendering remain later slices.
